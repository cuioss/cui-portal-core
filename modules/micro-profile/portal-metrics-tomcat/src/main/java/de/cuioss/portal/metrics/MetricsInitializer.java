...
class MetricsInitializer implements ApplicationInitializer {
     ...
     * <h1>Attention!</h1>
     * <p>
     * By contract, a servlet container creates one instance of each servlet. A dedicated thread is
    ...
    public void initialize() {
        if (!metricsEnabled) {
            ...
            // recognize amongst all servlet instances that the metrics registries has been filled
            initialized = true;
        }
    }
