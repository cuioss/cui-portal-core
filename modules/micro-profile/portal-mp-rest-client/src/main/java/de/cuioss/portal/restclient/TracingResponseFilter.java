...
/**
 * Response priority is sorted in descending order, that means filters with high priority numbers are processed first.
 * The RestEasy {@code org.jboss.resteasy.microprofile.client.ExceptionMapping} is set to priority 1 at
 * {@code org.jboss.resteasy.microprofile.client.RestClientBuilderImpl#build(java.lang.Class)}.
 * Therefore Tracing must have a higher value as it must be properly finished in order to be reported!
 *
 * @author Sven Haag
 */
@Provider
