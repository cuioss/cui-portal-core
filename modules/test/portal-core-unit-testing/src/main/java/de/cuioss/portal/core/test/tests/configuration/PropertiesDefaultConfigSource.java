 ...
 * Per default, the file must be provided under {@value PropertiesDefaultConfigSource#META_INF_LOCATION}.
 ...
 *
 * <p>This is a {@link FileConfigurationSource} too, to allow testing with AbstractConfigurationKeyVerifierTest.</p>
 *
 * <p><em>This class is not registered via SPI</em>, and doesn't need to. The unit test will only load the file to
 * compare it against the given class containing the possible config keys for that module.</p>
 *
 * @author Sven Haag
 */
final public class PropertiesDefaultConfigSource extends PropertiesConfigSource {
    ...
    /**
     * Loading properties from {@link #CLASSPATH_LOCATION}.
     * This basically is a convenience constructor for unit testing a modules default config.
     */
